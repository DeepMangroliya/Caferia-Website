    ...
    <div class="wrapper">
        ...
        <?php
            if(isset($_POST['submit'])){
                //echo "Clicked";
                //1. get data the value from our form
                $id = $_POST['id'];
                $title = $_POST['title'];
                ...
                if(isset($_FILES['image']['name'])){
                    ...
                    if($image_name != ""){
                        ...
                        if($current_image != ""){
                            ...
                            //if failed to remove then display message and top the process
                            if($remove==false){
                ...
                if($res2==true){
                    //category updated
                    $_SESSION['update'] = "<div class='success'>Categroy Updated Successfully.</div>";
                    header('location:'.SITEURL.'admin/manage-category.php');
                }
                else{
